...
could simply write it like this instead:
...
it doesn't already exist. We can fix that also running `mkdir -p`, before `cc`,
...
<!-- TODO: clean rule, header files,  -->

## Finishing touches

<div class="chapter" markdown="1" data-chapter="header-clean" data-prerequisite="folders">
...
We made two changes. First we added a `HEADERFILES` variable which contains a
list of header files, and added it as a _prerequisite_ to the `obj/%.o` rule.
...
are a student part of the 42 Network. I´ll help you get started.
